...
class ItemRequestRepositoryTest {
    ...
    @Test
    public void findByRequesterIdSuccess() {
        List<ItemRequest> checkList = itemRequestRepository.findByRequesterId(requester.getId(), params);
        assertEquals(request, checkList.get(0));
    }

    @Test
    public void findAllFromOthersSuccess() {
        List<ItemRequest> checkList = itemRequestRepository.findAllFromOthers(otherUser.getId(), params);
        assertEquals(request, checkList.get(0));
    }
}