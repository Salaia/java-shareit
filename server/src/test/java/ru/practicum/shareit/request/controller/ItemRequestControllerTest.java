...
class ItemRequestControllerTest {
    ...
    @Test
    public void findAllForRequesterWithZeroParams() throws Exception {
        when(itemRequestService.findAllForRequester(anyLong(), anyInt(), anyInt())).thenReturn(Collections.emptyList());
    ...
    public void failFindAllForRequesterSizeNegative() throws Exception {
        when(itemRequestService.findAllForRequester(anyLong(), anyInt(), anyInt())).thenThrow(new ValidationExceptionCustom("Wrong params"));
    ...
    public void returnEmptyListForAllUsers() throws Exception {
        when(itemRequestService.findAllFromOthers(anyLong(), anyInt(), anyInt())).thenReturn(Collections.emptyList());
    ...
    public void failFindAllForAllUsersSizeNegative() throws Exception {
        when(itemRequestService.findAllFromOthers(anyLong(), anyInt(), anyInt())).thenThrow(new ValidationExceptionCustom("Wrong params"));
    ...
    public void findByRequestIdSuccess() throws Exception {
        when(itemRequestService.findById(anyLong(), anyLong())).thenReturn(requestDtoOutput);
    ...
    public void failFindByIdNoRequest() throws Exception {
        when(itemRequestService.findById(anyLong(), anyLong())).thenThrow(new EntityNotFoundException("Not Found"));
